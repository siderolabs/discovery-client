...
#
# Generated on 2021-10-13T17:42:34Z by kres 2a27963-dirty.
...
RUN FILES="$(gofumports -l -local github.com/talos-systems/discovery-client .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'gofumports -w -local github.com/talos-systems/discovery-client .':\n${FILES}"; exit 1)
